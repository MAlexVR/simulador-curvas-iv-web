      ...
      <CardHeader className="pb-2 md:pb-3">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            >
              {isGeneratingPDF ? (
                <LoaderCircle className="w-3.5 h-3.5 mr-1 animate-spin" />
              ) : (
        ...
        <div className="p-3 bg-gray-50 rounded-lg border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-[10px] md:text-xs">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono">{results.jsc.toFixed(2)} mA/cm²</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Área</span>
              <span className="font-mono">{results.atotal.toFixed(4)} m²</span>
            </div>
          </div>
        </div>
